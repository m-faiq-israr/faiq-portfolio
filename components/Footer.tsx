  ...
  return (
    <footer className="w-full pt-20" id="contact">
      ...
      <div className="flex flex-col items-center">
        <h1 className="text-6xl font-bold text-white lg:max-w-[45vw]">
          Ready to take <span className="text-purple">your</span> digital
          presence to the next level?
        </h1>
        <p className="text-gray-300 text-xl md:mt-10 my-5 text-center">
      ...
      <div className="flex mt-16 md:flex-row flex-col justify-between items-center">
        <p className="md:text-lg text-sm md:font-normal font-light text-white">
